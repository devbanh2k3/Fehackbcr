...
function initialize() {
    ...
    $(".navUser").html(
        `<img src="resourcehttps://www.hackbcr.com/images/new/user.png" style="height:30px;">&nbsp; ${sessionStorage.User} &nbsp; </span>`
    );
    $(".navCredit").html(
        `<img src="resourcehttps://www.hackbcr.com/images/new/credit.png" style="height:30px;">&nbsp; ${$.number(
            sessionStorage.Credit
        )} &nbsp; </span>`
    );
    ...
    switch (sessionStorage.forType) {
        case "10":
            ...
            $(".sidenav").css(
                "background-image",
                'url("https://www.hackbcr.com/images/Sidebar_sahacker.png")'
            );
            break;
        case "2":
            link.rel = "stylesheet";
        ...
        case "5":
            ...
            $(".sidenav").css(
                "background-image",
                'url("https://www.hackbcr.com/images/02_Neon_Lobby_05_Sidebar.png")'
            );
            break;
        case "6":
            link.rel = "stylesheet";
        ...
        case "1":
            ...
            $(".sidenav").css(
                "background-image",
                "url(" + "https://www.hackbcr.com/images/new/" + asset_path + "/side_bar.png" + ")"
            );
    ...
    function getCase(result_type, result_value, result_id) {
        ...
        if (result_type == "text") {
            document.getElementById(`winrate${result_id}`).style.color =
                "khaki";
            document.getElementById(`winrate${result_id}`).innerHTML =
                result_value;
            switch (sessionStorage.forType) {
                case "10":
                ...
                case "2":
                    $(`#winrate${result_id}`)
                        .removeClass("te2_winrate_num")
                        .addClass("te2_winrate");
                    break;
                case "3":
                    $(`#winrate${result_id}`)
                        .removeClass("te2_winrate_num")
                ...
                case "4":
                    $(`#winrate${result_id}`)
                        .removeClass("te4_winrate_num")
                        .addClass("te4_winrate");
                    $(`#progbar_${result_id}`).css("width", "0%");
                    break;
                case "5":
                    $(`#winrate${result_id}`)
                        .removeClass("te5_winrate_num")
                        .addClass("te5_winrate");
                    document.getElementById(`status_game${result_id}`).src =
                        "resourcehttps://www.hackbcr.com/images/theme/neon/02_Neon_Lobby_06.png";
                    $(`#show_line${result_id}`).addClass("show_line_error");
                    break;
                case "6":
                    $(`#trophy_${result_id}`).attr(
                        "src",
                        "resourcehttps://www.hackbcr.com/images/theme/mayan/02_Mayan_Lobby_05.png"
                    );
                    $(`#diamond_${result_id}`).attr(
                        "src",
                        "resourcehttps://www.hackbcr.com/images/theme/mayan/02_Mayan_Lobby_10.png"
                    );
                    $(`#winrate${result_id}`)
                        .removeClass("te6_winrate_num")
                        .addClass("te6_winrate");
                    break;
                case "7":
                    $(`#winrate${result_id}`)
                        .removeClass("te2_winrate_num")
                        .addClass("te2_winrate");
                    document.getElementById(`status_game${result_id}`).src =
                        "resourcehttps://www.hackbcr.com/images/theme/china/02_China_Lobby_06.png";
                    break;
                case "8":
                    clearInterval(acc_interval[result_id]);
                    $(`#winrate${result_id}`)
                        .removeClass("te8_winrate_num")
                        .addClass("te8_winrate");
                ...
                case "9":
                    $(`#winrate${result_id}`)
                        ...
                        .addClass("te2_winrate");
                    document.getElementById(`status_game${result_id}`).src =
                        "resourcehttps://www.hackbcr.com/images/theme/skull/02_Skull_Lobby_14.png";
                    break;
                default:
            }
        } else {
...
function winterBar(bar_id, result_value) {
    ...
    if (result_value > 80) {
        $(`#progbar_${bar_id}`).css(
            "background-image",
            'url("resourcehttps://www.hackbcr.com/images/theme/winter/02_Winter_Lobby_04.png")'
        );
    } else if (result_value > 60) {
        $(`#progbar_${bar_id}`).css(
            "background-image",
            'url("resourcehttps://www.hackbcr.com/images/theme/winter/02_Winter_Lobby_05.png")'
        );
    } else {
        $(`#progbar_${bar_id}`).css(
            "background-image",
            'url("resourcehttps://www.hackbcr.com/images/theme/winter/02_Winter_Lobby_06.png")'
        );
    }
    ...
    let bar_interval = setInterval(function () {
        if (bar_count === range) {
            ...
            if (range != 0) {
                ...
                tbl_left_bar.rows[0].cells[bar_count - 1].classList.add(
                    `bar_fade`
                );
                tbl_left_bar.rows[0].cells[bar_count - 2].classList.add(
                    `bar_fade`
                );
                tbl_right_bar.rows[0].cells[19 - (bar_count - 1)].classList.add(
                    `bar_fade`
                );
                tbl_right_bar.rows[0].cells[19 - (bar_count - 2)].classList.add(
                    `bar_fade`
                );
            }
        } else {
            if (bar_count > 14) {
                tbl_left_bar.rows[0].cells[bar_count].classList.add(
                    `bar_color_${bar_id}`
                );
                tbl_right_bar.rows[0].cells[19 - bar_count].classList.add(
                    `bar_color_${bar_id}`
                );
                $(`.bar_color_${bar_id}`).css("backgroundColor", "lime");
