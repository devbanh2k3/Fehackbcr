$(document).ready(function () {
    ...
    //     // headers: {
    //     //     "X-CSRF-TOKEN": "HtaXJjbLguJ9GOpALWPSiTUXoymGZvTjs9QdRuIS"
    //     // },
    //     timeout: 30000,
    //     // data: {
    //     //     url: url,
...
function initialize() {
    ...
    let roomid = path[3].replace('.html', '');
    console.log("rôm", roomid)
    var predata = "";
    var count = 0;
    ...
    function showdata(data) {
        // if () {
        console.log('đã vào show data', data)
        if (predata != data) {
            // console.log(data);
            res = data.split("");
            ...
            if (!firstrun) {
                ...
                function timer() {
                    ...
                    if (waittime < 0) {
                        ...
                        document.getElementById('countdown2').innerHTML = "Wait a moment ..";
                        return;
                    }
                    ...
                    document.getElementById('countdown2').innerHTML = "Next round will start in " + waittime + " seconds";
                }
            }
            for (let i = 0; i < 72; i++) {
                if ((i % 6) == 0) col++;
                if (res[i] == 'B') {
                    ...
                    html = '<img src="https://www.hackbcr.com/images/symbol_b_small.png" style="height:30px;">';
                    banker++;
                    count++;
                    chkresult('b');
                } else if (res[i] == 'P') {
                    ...
                    html = '<img src="https://www.hackbcr.com/images/symbol_p_small.png" style="height:30px;">';
                    ...
                    html = '<img src="https://www.hackbcr.com/images/symbol_t_small.png" style="height:30px;">';
